...
module datapath_checker_imp_17S0UTF
   (S_AXI_CC_araddr,
    ...
    resetn,
    sys_resetn_out);
  input S_AXI_CC_araddr;
  output [0:0]S_AXI_CC_arready;
  input [0:0]S_AXI_CC_arvalid;
  input S_AXI_CC_awaddr;
  output [0:0]S_AXI_CC_awready;
  input [0:0]S_AXI_CC_awvalid;
  input [0:0]S_AXI_CC_bready;
  output [1:0]S_AXI_CC_bresp;
  output [0:0]S_AXI_CC_bvalid;
  output S_AXI_CC_rdata;
  input [0:0]S_AXI_CC_rready;
  output [1:0]S_AXI_CC_rresp;
  output [0:0]S_AXI_CC_rvalid;
  input S_AXI_CC_wdata;
  output [0:0]S_AXI_CC_wready;
  input S_AXI_CC_wstrb;
  input [0:0]S_AXI_CC_wvalid;
  input S_AXI_ER0_araddr;
  input [2:0]S_AXI_ER0_arprot;
  output [0:0]S_AXI_ER0_arready;
  input [0:0]S_AXI_ER0_arvalid;
  input S_AXI_ER0_awaddr;
  input [2:0]S_AXI_ER0_awprot;
  output [0:0]S_AXI_ER0_awready;
  input [0:0]S_AXI_ER0_awvalid;
  input [0:0]S_AXI_ER0_bready;
  output [1:0]S_AXI_ER0_bresp;
  output [0:0]S_AXI_ER0_bvalid;
  output S_AXI_ER0_rdata;
  input [0:0]S_AXI_ER0_rready;
  output [1:0]S_AXI_ER0_rresp;
  output [0:0]S_AXI_ER0_rvalid;
  input S_AXI_ER0_wdata;
  output [0:0]S_AXI_ER0_wready;
  input S_AXI_ER0_wstrb;
  input [0:0]S_AXI_ER0_wvalid;
  input S_AXI_ER1_araddr;
  input [2:0]S_AXI_ER1_arprot;
  output [0:0]S_AXI_ER1_arready;
  input [0:0]S_AXI_ER1_arvalid;
  input S_AXI_ER1_awaddr;
  input [2:0]S_AXI_ER1_awprot;
  output [0:0]S_AXI_ER1_awready;
  input [0:0]S_AXI_ER1_awvalid;
  input [0:0]S_AXI_ER1_bready;
  output [1:0]S_AXI_ER1_bresp;
  output [0:0]S_AXI_ER1_bvalid;
  output S_AXI_ER1_rdata;
  input [0:0]S_AXI_ER1_rready;
  output [1:0]S_AXI_ER1_rresp;
  output [0:0]S_AXI_ER1_rvalid;
  input S_AXI_ER1_wdata;
  output [0:0]S_AXI_ER1_wready;
  input S_AXI_ER1_wstrb;
  input [0:0]S_AXI_ER1_wvalid;
  input S_AXI_MC_araddr;
  input [2:0]S_AXI_MC_arprot;
  output [0:0]S_AXI_MC_arready;
  input [0:0]S_AXI_MC_arvalid;
  input S_AXI_MC_awaddr;
  input [2:0]S_AXI_MC_awprot;
  output [0:0]S_AXI_MC_awready;
  input [0:0]S_AXI_MC_awvalid;
  input [0:0]S_AXI_MC_bready;
  output [1:0]S_AXI_MC_bresp;
  output [0:0]S_AXI_MC_bvalid;
  output S_AXI_MC_rdata;
  input [0:0]S_AXI_MC_rready;
  output [1:0]S_AXI_MC_rresp;
  output [0:0]S_AXI_MC_rvalid;
  input S_AXI_MC_wdata;
  output [0:0]S_AXI_MC_wready;
  input S_AXI_MC_wstrb;
  input [0:0]S_AXI_MC_wvalid;
  output ch0_ok;
  output ch1_ok;
  input clk;
  ...
  assign S_AXI_CC_arready[0] = smartconnect_M00_AXI_ARREADY;
  assign S_AXI_CC_awready[0] = smartconnect_M00_AXI_AWREADY;
  assign S_AXI_CC_bresp[1:0] = smartconnect_M00_AXI_BRESP;
  assign S_AXI_CC_bvalid[0] = smartconnect_M00_AXI_BVALID;
  assign S_AXI_CC_rdata = smartconnect_M00_AXI_RDATA[0];
  assign S_AXI_CC_rresp[1:0] = smartconnect_M00_AXI_RRESP;
  assign S_AXI_CC_rvalid[0] = smartconnect_M00_AXI_RVALID;
  assign S_AXI_CC_wready[0] = smartconnect_M00_AXI_WREADY;
  assign S_AXI_ER0_arready[0] = S_AXI_ER_1_ARREADY;
  assign S_AXI_ER0_awready[0] = S_AXI_ER_1_AWREADY;
  assign S_AXI_ER0_bresp[1:0] = S_AXI_ER_1_BRESP;
  assign S_AXI_ER0_bvalid[0] = S_AXI_ER_1_BVALID;
  assign S_AXI_ER0_rdata = S_AXI_ER_1_RDATA;
  assign S_AXI_ER0_rresp[1:0] = S_AXI_ER_1_RRESP;
  assign S_AXI_ER0_rvalid[0] = S_AXI_ER_1_RVALID;
  assign S_AXI_ER0_wready[0] = S_AXI_ER_1_WREADY;
  assign S_AXI_ER1_1_ARADDR = S_AXI_ER1_araddr;
  assign S_AXI_ER1_1_ARPROT = S_AXI_ER1_arprot[2:0];
  assign S_AXI_ER1_1_ARVALID = S_AXI_ER1_arvalid[0];
  assign S_AXI_ER1_1_AWADDR = S_AXI_ER1_awaddr;
  assign S_AXI_ER1_1_AWPROT = S_AXI_ER1_awprot[2:0];
  assign S_AXI_ER1_1_AWVALID = S_AXI_ER1_awvalid[0];
  assign S_AXI_ER1_1_BREADY = S_AXI_ER1_bready[0];
  assign S_AXI_ER1_1_RREADY = S_AXI_ER1_rready[0];
  assign S_AXI_ER1_1_WDATA = S_AXI_ER1_wdata;
  assign S_AXI_ER1_1_WSTRB = S_AXI_ER1_wstrb;
  assign S_AXI_ER1_1_WVALID = S_AXI_ER1_wvalid[0];
  assign S_AXI_ER1_arready[0] = S_AXI_ER1_1_ARREADY;
  assign S_AXI_ER1_awready[0] = S_AXI_ER1_1_AWREADY;
  assign S_AXI_ER1_bresp[1:0] = S_AXI_ER1_1_BRESP;
  assign S_AXI_ER1_bvalid[0] = S_AXI_ER1_1_BVALID;
  assign S_AXI_ER1_rdata = S_AXI_ER1_1_RDATA;
  assign S_AXI_ER1_rresp[1:0] = S_AXI_ER1_1_RRESP;
  assign S_AXI_ER1_rvalid[0] = S_AXI_ER1_1_RVALID;
  assign S_AXI_ER1_wready[0] = S_AXI_ER1_1_WREADY;
  assign S_AXI_ER_1_ARADDR = S_AXI_ER0_araddr;
  assign S_AXI_ER_1_ARPROT = S_AXI_ER0_arprot[2:0];
  assign S_AXI_ER_1_ARVALID = S_AXI_ER0_arvalid[0];
  assign S_AXI_ER_1_AWADDR = S_AXI_ER0_awaddr;
  assign S_AXI_ER_1_AWPROT = S_AXI_ER0_awprot[2:0];
  assign S_AXI_ER_1_AWVALID = S_AXI_ER0_awvalid[0];
  assign S_AXI_ER_1_BREADY = S_AXI_ER0_bready[0];
  assign S_AXI_ER_1_RREADY = S_AXI_ER0_rready[0];
  assign S_AXI_ER_1_WDATA = S_AXI_ER0_wdata;
  assign S_AXI_ER_1_WSTRB = S_AXI_ER0_wstrb;
  assign S_AXI_ER_1_WVALID = S_AXI_ER0_wvalid[0];
  assign S_AXI_MC_1_ARADDR = S_AXI_MC_araddr;
  assign S_AXI_MC_1_ARPROT = S_AXI_MC_arprot[2:0];
  assign S_AXI_MC_1_ARVALID = S_AXI_MC_arvalid[0];
  assign S_AXI_MC_1_AWADDR = S_AXI_MC_awaddr;
  assign S_AXI_MC_1_AWPROT = S_AXI_MC_awprot[2:0];
  assign S_AXI_MC_1_AWVALID = S_AXI_MC_awvalid[0];
  assign S_AXI_MC_1_BREADY = S_AXI_MC_bready[0];
  assign S_AXI_MC_1_RREADY = S_AXI_MC_rready[0];
  assign S_AXI_MC_1_WDATA = S_AXI_MC_wdata;
  assign S_AXI_MC_1_WSTRB = S_AXI_MC_wstrb;
  assign S_AXI_MC_1_WVALID = S_AXI_MC_wvalid[0];
  assign S_AXI_MC_arready[0] = S_AXI_MC_1_ARREADY;
  assign S_AXI_MC_awready[0] = S_AXI_MC_1_AWREADY;
  assign S_AXI_MC_bresp[1:0] = S_AXI_MC_1_BRESP;
  assign S_AXI_MC_bvalid[0] = S_AXI_MC_1_BVALID;
  assign S_AXI_MC_rdata = S_AXI_MC_1_RDATA[0];
  assign S_AXI_MC_rresp[1:0] = S_AXI_MC_1_RRESP;
  assign S_AXI_MC_rvalid[0] = S_AXI_MC_1_RVALID;
  assign S_AXI_MC_wready[0] = S_AXI_MC_1_WREADY;
  ...
  assign smartconnect_M00_AXI_ARADDR = S_AXI_CC_araddr;
  assign smartconnect_M00_AXI_ARVALID = S_AXI_CC_arvalid[0];
  assign smartconnect_M00_AXI_AWADDR = S_AXI_CC_awaddr;
  assign smartconnect_M00_AXI_AWVALID = S_AXI_CC_awvalid[0];
  assign smartconnect_M00_AXI_BREADY = S_AXI_CC_bready[0];
  assign smartconnect_M00_AXI_RREADY = S_AXI_CC_rready[0];
  assign smartconnect_M00_AXI_WDATA = S_AXI_CC_wdata;
  assign smartconnect_M00_AXI_WSTRB = S_AXI_CC_wstrb;
  assign smartconnect_M00_AXI_WVALID = S_AXI_CC_wvalid[0];
  ...
  top_level_mindy_core_ctl_0_0 mindy_core_ctl
       (.FRAME_SIZE(mindy_core_ctl_0_FRAME_SIZE),
        ...
        .S_AXI_ARADDR({S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR,S_AXI_MC_1_ARADDR}),
        .S_AXI_ARPROT(S_AXI_MC_1_ARPROT),
        .S_AXI_ARREADY(S_AXI_MC_1_ARREADY),
        .S_AXI_ARVALID(S_AXI_MC_1_ARVALID),
        .S_AXI_AWADDR({S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR,S_AXI_MC_1_AWADDR}),
        ...
        .S_AXI_WDATA({S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA,S_AXI_MC_1_WDATA}),
        .S_AXI_WREADY(S_AXI_MC_1_WREADY),
        .S_AXI_WSTRB({S_AXI_MC_1_WSTRB,S_AXI_MC_1_WSTRB,S_AXI_MC_1_WSTRB,S_AXI_MC_1_WSTRB}),
...
module reporter_0_imp_14RIEO2
  ...
  input S_AXI_ER_araddr;
  input [2:0]S_AXI_ER_arprot;
  output [0:0]S_AXI_ER_arready;
  input [0:0]S_AXI_ER_arvalid;
  input S_AXI_ER_awaddr;
  input [2:0]S_AXI_ER_awprot;
  output [0:0]S_AXI_ER_awready;
  input [0:0]S_AXI_ER_awvalid;
  input [0:0]S_AXI_ER_bready;
  output [1:0]S_AXI_ER_bresp;
  output [0:0]S_AXI_ER_bvalid;
  output S_AXI_ER_rdata;
  input [0:0]S_AXI_ER_rready;
  output [1:0]S_AXI_ER_rresp;
  output [0:0]S_AXI_ER_rvalid;
  input S_AXI_ER_wdata;
  output [0:0]S_AXI_ER_wready;
  input S_AXI_ER_wstrb;
  input [0:0]S_AXI_ER_wvalid;
  ...
  assign Conn1_ARADDR = S_AXI_ER_araddr;
  assign Conn1_ARPROT = S_AXI_ER_arprot[2:0];
  assign Conn1_ARVALID = S_AXI_ER_arvalid[0];
  assign Conn1_AWADDR = S_AXI_ER_awaddr;
  assign Conn1_AWPROT = S_AXI_ER_awprot[2:0];
  assign Conn1_AWVALID = S_AXI_ER_awvalid[0];
  assign Conn1_BREADY = S_AXI_ER_bready[0];
  assign Conn1_RREADY = S_AXI_ER_rready[0];
  assign Conn1_WDATA = S_AXI_ER_wdata;
  assign Conn1_WSTRB = S_AXI_ER_wstrb;
  assign Conn1_WVALID = S_AXI_ER_wvalid[0];
  ...
  assign S_AXI_ER_arready[0] = Conn1_ARREADY;
  assign S_AXI_ER_awready[0] = Conn1_AWREADY;
  assign S_AXI_ER_bresp[1:0] = Conn1_BRESP;
  assign S_AXI_ER_bvalid[0] = Conn1_BVALID;
  assign S_AXI_ER_rdata = Conn1_RDATA[0];
  assign S_AXI_ER_rresp[1:0] = Conn1_RRESP;
  assign S_AXI_ER_rvalid[0] = Conn1_RVALID;
  assign S_AXI_ER_wready[0] = Conn1_WREADY;
  ...
  top_level_axi_reporter_0_0 axi_reporter
       (.S_AXI_ARADDR({Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR,Conn1_ARADDR}),
        .S_AXI_ARPROT(Conn1_ARPROT),
        .S_AXI_ARREADY(Conn1_ARREADY),
        .S_AXI_ARVALID(Conn1_ARVALID),
        .S_AXI_AWADDR({Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR,Conn1_AWADDR}),
        ...
        .S_AXI_WDATA({Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA,Conn1_WDATA}),
        .S_AXI_WREADY(Conn1_WREADY),
        .S_AXI_WSTRB({Conn1_WSTRB,Conn1_WSTRB,Conn1_WSTRB,Conn1_WSTRB}),
...
module reporter_1_imp_YQ6NLO
  ...
  assign S_AXI_ER_1_ARADDR = S_AXI_ER_araddr;
  assign S_AXI_ER_1_ARPROT = S_AXI_ER_arprot[2:0];
  assign S_AXI_ER_1_ARVALID = S_AXI_ER_arvalid[0];
  assign S_AXI_ER_1_AWADDR = S_AXI_ER_awaddr;
  assign S_AXI_ER_1_AWPROT = S_AXI_ER_awprot[2:0];
  assign S_AXI_ER_1_AWVALID = S_AXI_ER_awvalid[0];
  assign S_AXI_ER_1_BREADY = S_AXI_ER_bready[0];
  assign S_AXI_ER_1_RREADY = S_AXI_ER_rready[0];
  assign S_AXI_ER_1_WDATA = S_AXI_ER_wdata;
  assign S_AXI_ER_1_WSTRB = S_AXI_ER_wstrb;
  assign S_AXI_ER_1_WVALID = S_AXI_ER_wvalid[0];
  assign S_AXI_ER_arready[0] = S_AXI_ER_1_ARREADY;
  assign S_AXI_ER_awready[0] = S_AXI_ER_1_AWREADY;
  assign S_AXI_ER_bresp[1:0] = S_AXI_ER_1_BRESP;
  assign S_AXI_ER_bvalid[0] = S_AXI_ER_1_BVALID;
  assign S_AXI_ER_rdata = S_AXI_ER_1_RDATA[0];
  assign S_AXI_ER_rresp[1:0] = S_AXI_ER_1_RRESP;
  assign S_AXI_ER_rvalid[0] = S_AXI_ER_1_RVALID;
  assign S_AXI_ER_wready[0] = S_AXI_ER_1_WREADY;
  assign axis_in0_1_TDATA = axis_in_tdata[31:0];
  assign axis_in0_1_TVALID = axis_in_tvalid;
  assign axis_in_tready = axis_in0_1_TREADY;
  ...
  top_level_axi_reporter_0_2 axi_reporter
       (.S_AXI_ARADDR({S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR,S_AXI_ER_1_ARADDR}),
        .S_AXI_ARPROT(S_AXI_ER_1_ARPROT),
        .S_AXI_ARREADY(S_AXI_ER_1_ARREADY),
        .S_AXI_ARVALID(S_AXI_ER_1_ARVALID),
        .S_AXI_AWADDR({S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR,S_AXI_ER_1_AWADDR}),
        ...
        .S_AXI_WDATA({S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA,S_AXI_ER_1_WDATA}),
        .S_AXI_WREADY(S_AXI_ER_1_WREADY),
        .S_AXI_WSTRB({S_AXI_ER_1_WSTRB,S_AXI_ER_1_WSTRB,S_AXI_ER_1_WSTRB,S_AXI_ER_1_WSTRB}),
...
module top_level
   (init_clk,
    ...
    qsfp_lp,
    qsfp_rst_l);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.INIT_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.INIT_CLK, CLK_DOMAIN top_level_init_clk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input init_clk;
  ...
  wire S_AXI_MC_1_ARADDR;
  wire [2:0]S_AXI_MC_1_ARPROT;
  wire [0:0]S_AXI_MC_1_ARREADY;
  wire [0:0]S_AXI_MC_1_ARVALID;
  wire S_AXI_MC_1_AWADDR;
  wire [2:0]S_AXI_MC_1_AWPROT;
  wire [0:0]S_AXI_MC_1_AWREADY;
  wire [0:0]S_AXI_MC_1_AWVALID;
  wire [0:0]S_AXI_MC_1_BREADY;
  wire [1:0]S_AXI_MC_1_BRESP;
  wire [0:0]S_AXI_MC_1_BVALID;
  wire S_AXI_MC_1_RDATA;
  wire [0:0]S_AXI_MC_1_RREADY;
  wire [1:0]S_AXI_MC_1_RRESP;
  wire [0:0]S_AXI_MC_1_RVALID;
  wire S_AXI_MC_1_WDATA;
  wire [0:0]S_AXI_MC_1_WREADY;
  wire S_AXI_MC_1_WSTRB;
  wire [0:0]S_AXI_MC_1_WVALID;
  wire axi_resetn_1;
  wire [3:0]cmac_usplus_0_gt_serial_port_GRX_N;
  ...
  top_level_smartconnect_0_0 smartconnect
       (.M00_AXI_araddr(smartconnect_M00_AXI_ARADDR),
        ...
        .M03_AXI_rdata(S_AXI_MC_1_RDATA),
        .M03_AXI_rid(1'b0),
        .M03_AXI_rlast(1'b0),
        ...
        .M04_AXI_rdata(S_AXI_ER_1_RDATA),
        .M04_AXI_rid(1'b0),
        .M04_AXI_rlast(1'b0),
        ...
        .M06_AXI_rdata(S_AXI_ER1_1_RDATA),
        .M06_AXI_rid(1'b0),
        .M06_AXI_rlast(1'b0),
